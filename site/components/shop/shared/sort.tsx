    ...
    <div>
      <div className="relative">
        <div
          ...
          className="bg-[#F2F2F2] rounded-[50px]  flex flex-row-reverse px-10 py-2 cursor-pointer screen950:px-6
          screen750:px-2"
        >
          <Image
            src="/images/Sort.png"
          ...
          />
          <span className="text-[#979797] my-auto text-[20px] whitespace-nowrap
          screen1440:text-lg
          screen950:text-base
          screen750:hidden">مرتب سازی</span>
        </div>
        {showSort && (
          <>
            <div
