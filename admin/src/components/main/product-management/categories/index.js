                      ...
                      return (
                        <div key={subCat?.id}>
                          <div className=" w-full flex flex-row space-x-4 space-x-reverse my-4 ">
                            ...
                            >
                              {/* {!imagePreview[category.id] && !subCat.image ? (
                                <div
                                  onClick={() => handleEditClick(category.id)}
                                  className="flex justify-center items-center cursor-pointer w-full h-full bg-gray-200 rounded-lg"
                                >
                                  <img
                                    src={addImageIcon}
                                    alt="Add Image"
                                ...
                                <img
                                  src={
                                    imagePreview[`${category.id}-${subCat.id}`]
                                  }
