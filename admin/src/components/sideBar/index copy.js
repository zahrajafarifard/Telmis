...
import NotiIcon from "../../assets/images/notif.svg";
import lightNotiIcon from "../../assets/images/lightNotif_Icon.svg";
import FinancialIcon from "../../assets/images/financial.svg";
import lightFinancialIcon from "../../assets/images/lightFinancial_Icon.svg";
import NewUserIcon from "../../assets/images/new-user.svg";
import lightUserIcon from "../../assets/images/light_user.svg";
import ArticleIcon from "../../assets/images/upload-article.svg";
import lightArticleIcon from "../../assets/images/lightArticle_Icon.svg";
import JobIcon from "../../assets/images/job-sidbar.svg";
import lightJobIcon from "../../assets/images/lightJob_Icon.svg";
import ProdIcon from "../../assets/images/upload-prod.svg";
import lightProdIcon from "../../assets/images/lightProduct_Icon.svg";
...
function Sidebar() {
  ...
  const getInitialShowItems = () => {
    ...
    if (
      ...
      return "products";
    if (["/exchange", "/receipts", "/files"].includes(location.pathname))
      return "exchange";
    if (
      [
        "/job-positions",
      ...
      <div className="text-base text-[#6D6F72]">
              ...
              <div className="flex flex-row justify-between w-full">
                <div className="flex flex-row">
                  <img
                    ...
                    className="w-6 h-6 my-auto"
                  />
                  <span className="px-6">مدیریت محصولات </span>
                </div>
                <img
        ...
        <div className="relative">
          <NavLink
            to="/receipts"
            onClick={() =>
              setShowItems((prev) => (prev !== "exchange" ? "exchange" : ""))
            }
          >
            <div
              className={`flex flex-row p-4 ${
              ...
              <div className="flex flex-row justify-between w-full">
                <div className="flex flex-row">
                  <img
                    ...
                    className="w-6 h-6 my-auto"
                  />
                  <span className="px-6">مدیریت صرافی </span>
                </div>
                <img
                  src={showItems === "exchange" ? lightIcon : darkIcon}
                  className={`w-6 h-6 my-auto `}
                />
              </div>
            </div>
            ...
            <div className="static top-10 right-0 my-7">
              ...
              >
                <input
                  type="radio"
                  className="accent-[#A60014]"
                  checked={["/receipts"].includes(location.pathname)}
                  onChange={() => null}
                />
                <span className="ps-6">گزارشات مالی</span>
              </NavLink>
              <NavLink
                to="/files"
                className="flex px-4 justify-start py-2 mb-3"
              >
                <input
                  ...
                  onChange={() => null}
                />
                <span className="ps-6"> فایل های دانلودی</span>
              </NavLink>
            </div>
          )}
        </div>
              ...
              <div className="flex flex-row justify-between w-full">
                <div className="flex flex-row">
                  <img
                    ...
                    className="w-6 h-6 my-auto"
                  />
                  <span className="px-6">موقعیت شغلی</span>
                </div>
                <img
            ...
            <div className="static top-10 right-0 my-7">
              ...
              >
                <input
                  ...
                  onChange={() => null}
                />
                <span className="ps-6">مشاهده موقعیت های شغلی </span>
              </NavLink>
              ...
              >
                <input
                  type="radio"
                  className="accent-[#A60014]"
                  checked={["/add-job-position"].includes(location.pathname)}
                  onChange={() => null}
                />
                <span className="ps-6">بارگذاری موقعیت شغلی</span>
              </NavLink> */}
              <NavLink
              ...
              <div className="flex flex-row justify-between w-full">
                <div className="flex flex-row">
                  <img
                    ...
                    className="w-6 h-6 my-auto"
                  />
                  <span className="px-6">مدیریت مقالات</span>
                </div>
                <img
            ...
            <div className="static top-10 right-0 my-7">
              ...
              >
                <input
                  type="radio"
                  className="accent-[#A60014]"
                  checked={["/add-new-article"].includes(location.pathname)}
                  onChange={() => null}
                />
                <span className="ps-6">بارگذاری مقاله</span>
              </NavLink> */}
